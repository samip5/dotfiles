...
- [../flake.lock](../flake.lock) is the lock file, updated daily by `samip5-bot` powered by [Renovate](https://github.com/renovatebot/renovate).
...
- Copy a directory in `./hosts` to your machine name, i.e from the root of this repo do `cp ./nixos/hosts/aurora ./nixos/hosts/your-machine`
...
I stole most of this from [budimanjojo/dotfiles/](https://github.com/budimanjojo/dotfiles/), but with own tweaking.
